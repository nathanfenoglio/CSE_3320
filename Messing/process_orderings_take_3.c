...
int main(int argc, char **argv){
    ...
    printf("num_processes: \n");
    scanf("%d", &num_processes);

    //not using right now, 
    //but would like to use to run multiple goes of this 
    //per how many permutations of the arrival times there are 
    //and output relevant data to an output file
    printf("num_permutations: \n");
    scanf("%d", &num_permutations); 
    getchar();
    ...
    */
    getchar();
    for(i = 0; i < num_processes; i++){
        printf("proc_info_arr[%d]->duration: \n", i);
        scanf("%d", &proc_info_arr[i]->duration);
    }
    getchar();
    for(i = 0; i < num_processes; i++){
        printf("proc_info_arr[%d]->arrival: \n", i);
        scanf("%d", &proc_info_arr[i]->arrival);
    }
