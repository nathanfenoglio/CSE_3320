...
SYSCALL_DEFINE2(virt_address_status, unsigned long, mem, int, pid){
        ...
        In a two or three-level paging system, this macro yields pgd, the address of a Page Global Directory entry.*/
        ...
        The macro yields the address of the entry in a Page Middle Directory that corresponds to addr. 
